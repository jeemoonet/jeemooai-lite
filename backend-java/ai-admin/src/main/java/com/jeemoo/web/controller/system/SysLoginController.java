...
import com.jeemoo.common.core.domain.model.EmailLoginBody;
import com.jeemoo.common.core.domain.model.LoginBody;
import com.jeemoo.common.core.domain.model.LoginUser;
import com.jeemoo.common.core.domain.model.SmsLoginBody;
...
import com.jeemoo.system.service.SysLoginService;
...
public class SysLoginController {
    ...
    public R<Map<String, Object>> smsLogin(@Validated @RequestBody SmsLoginBody smsLoginBody) {
        Map<String, Object> ajax = new HashMap<>();
        // 生成令牌
        String token = loginService.smsLogin(smsLoginBody.getPhonenumber(), smsLoginBody.getSmsCode(), UserType.APP_USER.getUserType());
        ajax.put(Constants.TOKEN, token);
        return R.ok(ajax);
    }

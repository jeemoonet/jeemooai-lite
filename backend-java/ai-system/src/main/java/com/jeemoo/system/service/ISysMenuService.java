...
public interface ISysMenuService {
    ...
    List<SysMenu> selectCompanyMenuList(LoginUser loginUser, AiCompanyVo companyVo);

    Collection<String> selectAllCompanyPerms();

    List<SysMenu> list(QueryWrapper<SysMenu> queryWrapper);
}

...
public interface ISysUserService {
     ...
     * @param bo
     */
    void setCompany(SysUser user, AiCompanyBo bo);

    TableDataInfo<SysUser> selectPageByUser(SysUser user, LoginUser loginUser, PageQuery pageQuery);

    void checkUserLimit(LoginUser loginUser);

    void setIsAlert(Long userId, Integer isAlert);
}

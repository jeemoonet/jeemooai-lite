...
public class RedisUtils {
    ...
    public static String getString(String key) {
        ...
        RBucket<String> bucket = CLIENT.getBucket(key,stringCodec);
        return bucket.get();
    }

    public static void setJSON(String key, JSONObject value, Duration duration) {
        StringCodec stringCodec = new StringCodec();
        RBucket<String> bucket = CLIENT.getBucket(key,stringCodec);
        bucket.set(JSONUtil.toJsonStr(value));
